...
export function ColorField({
  ...
  return (
    <View
      style={[
        styles.colorField,
        isExpanded && styles.colorFieldExpanded,
      ]}
    >
      <Pressable
        style={[
      ...
      {isExpanded && (
        <View style={styles.channelGroup}>
          <View style={styles.channelRow}>
            <Text style={[styles.channelLabel, { color: chrome.channelLabelColor }]}>R</Text>
            <Slider
          ...
          <View style={styles.channelRow}>
            <Text style={[styles.channelLabel, { color: chrome.channelLabelColor }]}>G</Text>
            <Slider
              style={styles.channelSlider}
              minimumValue={0}
              maximumValue={255}
          ...
          <View style={styles.channelRow}>
            <Text style={[styles.channelLabel, { color: chrome.channelLabelColor }]}>B</Text>
            <Slider
              style={styles.channelSlider}
              minimumValue={0}
              maximumValue={255}
