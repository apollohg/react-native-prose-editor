...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_FN_FUNC_EDITOR_TOGGLE_CODE_BLOCK
#define UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_FN_FUNC_EDITOR_TOGGLE_CODE_BLOCK
RustBuffer uniffi_editor_core_fn_func_editor_toggle_code_block(uint64_t id, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_FN_FUNC_EDITOR_TOGGLE_CODE_BLOCK_AT_SELECTION_SCALAR
#define UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_FN_FUNC_EDITOR_TOGGLE_CODE_BLOCK_AT_SELECTION_SCALAR
RustBuffer uniffi_editor_core_fn_func_editor_toggle_code_block_at_selection_scalar(uint64_t id, uint32_t scalar_anchor, uint32_t scalar_head, RustCallStatus *_Nonnull out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_CHECKSUM_FUNC_EDITOR_TOGGLE_CODE_BLOCK
#define UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_CHECKSUM_FUNC_EDITOR_TOGGLE_CODE_BLOCK
uint16_t uniffi_editor_core_checksum_func_editor_toggle_code_block(void

);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_CHECKSUM_FUNC_EDITOR_TOGGLE_CODE_BLOCK_AT_SELECTION_SCALAR
#define UNIFFI_FFIDEF_UNIFFI_EDITOR_CORE_CHECKSUM_FUNC_EDITOR_TOGGLE_CODE_BLOCK_AT_SELECTION_SCALAR
uint16_t uniffi_editor_core_checksum_func_editor_toggle_code_block_at_selection_scalar(void
