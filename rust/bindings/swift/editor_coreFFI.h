...
RustBuffer uniffi_editor_core_fn_func_editor_v2_collaboration_receive(RustBuffer editor_id, uint64_t generation, RustBuffer message, RustCallStatus *_Nonnull out_status
);
#endif
...
RustBuffer uniffi_editor_core_fn_func_editor_v2_collaboration_socket_close(RustBuffer editor_id, uint64_t generation, RustBuffer code, RustBuffer reason, RustCallStatus *_Nonnull out_status
);
#endif
...
RustBuffer uniffi_editor_core_fn_func_editor_v2_collaboration_socket_open(RustBuffer editor_id, uint64_t generation, RustCallStatus *_Nonnull out_status
);
#endif
...
RustBuffer uniffi_editor_core_fn_func_editor_v2_collaboration_take_outbound(RustBuffer editor_id, uint64_t generation, RustCallStatus *_Nonnull out_status
);
#endif
