...
use editor_core::collaboration_runtime::state::{
...
fn await_remote_rooms_connect_without_document_promotion() {
    ...
    assert_eq!(
        editor_core::session_initialization_test_support::document_state(id).unwrap(),
...
fn receive_message_is_generation_gated_across_all_live_transport_states() {
    use editor_core::session_initialization_test_support::receive_message;
