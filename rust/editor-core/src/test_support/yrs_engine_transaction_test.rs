...
struct RejectedTransactionAudit {
    ...
    relative_selection: Option<crate::yrs_engine::RelativeSelection>,
    resolved_selection: Option<crate::yrs_engine::ResolvedSelection>,
...
fn audit(engine: &YrsDocumentEngine) -> RejectedTransactionAudit {
    ...
    RejectedTransactionAudit {
        ...
        stored_marks: engine.stored_marks().map(<[Mark]>::to_vec),
